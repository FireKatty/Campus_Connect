...
public class NotificationController {
    ...
    public ResponseEntity<List<Notification>> getNotificationsForProfessors() {
        List<Notification> notifications = notificationService.getNotificationsForProfessors();
        return ResponseEntity.ok(notifications);
    }
    
    @GetMapping("/student")
    public ResponseEntity<List<Notification>> getNotificationsForStudents() {
        List<Notification> notifications = notificationService.getNotificationsForStudents();
        return ResponseEntity.ok(notifications);
    }
}
