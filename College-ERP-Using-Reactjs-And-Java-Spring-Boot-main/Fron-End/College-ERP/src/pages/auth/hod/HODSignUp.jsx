...
export function HODSignUp() {
  ...
  //       "http://localhost:8080/api/hods/add-hod",
  //       formData,
  //       {
  //         headers: {
  ...
  //     } else {
  //       setError("Error uploading hod data. Please try again.");
  //     }
  //   } finally {
  //     setLoading(false);
  //   }
  ...
  const formData = new FormData();
  formData.append("file", imageUrl); // ✅ append the file here
  formData.append("name", name);
  formData.append("department", department);
  formData.append("username", username);
  formData.append("password", password);
  formData.append("email", email);
  formData.append("phone", phone);
  formData.append("subjects", subjects); // ✅ no need to split here
