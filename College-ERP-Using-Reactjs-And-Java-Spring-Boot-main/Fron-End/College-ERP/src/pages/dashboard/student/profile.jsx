...
//                   Email: student.email, // Directly access the email property
  ...
  const handleSave = async () => {
    try {
      const response = await fetch(
        `http://localhost:8080/api/students/${student.id}`, // Adjust API path
        {
          method: "PUT",
