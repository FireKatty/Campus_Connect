...
const MailSender = () => {
  ...
  const fetchProfessors = async () => {
    const response = await axios.get("http://localhost:8080/api/professors/get-prof"); // Adjust endpoint as needed
  ...
  if (recipientType === "selected-students") {
    selectedStudents.forEach(student =>
      formData.append("selectedStudents", student)
    );
  } else if (recipientType === "selected-professors") {
    selectedProfessors.forEach(professor =>
      formData.append("selectedProfessors", professor)
    );
  } else if (
    recipientType === "individual-student" ||
    recipientType === "individual-professor"
